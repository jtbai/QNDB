...
$MainOutput->OpenCol('',4);
	...
	$MainOutput->addlink('index.php?Section=Form_Message','<img border=0 src=images/insert.png>');
$MainOutput->CloseCol();
$MainOutput->CloseRow();
...
while($Rep = $SQL->FetchArray()){
	...
	$MainOutput->OpenRow();
		$MainOutput->OpenCol('20');
		$MainOutput->addlink('index.php?Section=Form_Message&IDMessage='.$Rep['IDMessage'],'<img border=0 src=images/edit.png>');
		$MainOutput->CloseCol();

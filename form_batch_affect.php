...
$MainOutput->InputHidden_Env('Action','Batch_Affect');
...
$Req = "SELECT DISTINCT min(IDPeriode) FROM periode WHERE IDPiscine = ".$_GET['IDPiscine']." AND IDSession =".$_ACTIVE['Session']." AND Jour=".$_GET['Jour']." GROUP BY Jour, Start, IDPiscine, IDSession ORDER BY Start ASC";
$SQL->SELECT($Req);
$SQL2 = new sqlclass();
